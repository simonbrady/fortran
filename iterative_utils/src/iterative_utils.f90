! Common utility functions for iterative solvers
!
...
! 21-Mar-2015  SJB  Add iterative_utils_version
...
module iterative_utils
    ...
    public :: iterative_utils_version
...
contains
    ...
    character(len=50) function iterative_utils_version()
        include "git_revision.fi"
        iterative_utils_version = 'iterative_utils (git ' // git_revision // ')'
