! Jacobi, Gauss-Seidel and SOR iterative solvers - OpenMP version
!
...
contains
    ...
    ! The main loop is an OpenMP parallel do, so it is up to the caller to
    ! initialise OpenMP and set the thread count.
